...
export function weeklyReportEmail({ shopDomain, metrics, appUrl, brandName = null }) {
  ...
  `;
  return {
    subject: `${brandName || 'CreditLoop'} weekly report — ${shopDomain}`,
    html: renderMerchantLayout({ heading: 'Your weekly credit report', body, brandName }),
